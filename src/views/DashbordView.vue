                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="section-title text-center">
                            ...
                            <p>
                                "Organisez et participez sans stress, vos événements à portée de clic !"
                            </p>
                        </div>
                    </div>
                    <!-- /.col end-->
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <ul class="nav custom-tab" id="myTab" role="tablist">
                            <li class="nav-item">
                                <a class="nav-link active show" id="home-taThursday" data-toggle="tab" :href="`/Dash`"
                                    role="tab" aria-controls="home" aria-selected="true">Dasboard</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" id="profile-tab" data-toggle="tab" :href="`/Ticket`" role="tab"
                                    aria-controls="profile" aria-selected="false">Evenement</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" id="contact-tab" data-toggle="tab" :href="`/Paie`" role="tab"
                                    aria-controls="contact" aria-selected="false">Paiement</a>
                            </li>
                            <li class="nav-item d-none d-lg-block">
                                <a class="nav-link" id="sunday-tab" data-toggle="tab" :href="`/count`" role="tab"
                                    aria-controls="sunday" aria-selected="false">Utilisateur</a>
                            </li>
                        </ul>
                                            ...
                                            <tr class="inner-box">
                                                ...
                                                <td>
                                                    <div class="primary-btn">
                                                        <a class="btn btn-primary" :href="`/User`" >Read More</a>
                                                    </div>
                                                </td>
                                            </tr>
                                            <tr class="inner-box">
