                                                   ...
                                                   <tr  v-for="events in eventdetails" v-bind:key="events.id">
                                                       ...
                                                       <td class="align-middle text-center">
                                                           <div class="bg-light d-inline-flex justify-content-center align-items-center align-top"
                                                               ...
                                                               <i class="fa fa-fw fa-photo" style="opacity: 0.8;">
                                                                {{ events.photo }}
                                                               </i>
                                                           </div>
                                                       </td>
                                                       ...
                                                       <td class="text-nowrap align-middle">{{ events.description }}</td>
                                                       <td class="text-nowrap align-middle">{{ events.artiste }}</td>
                                                       <td class="text-nowrap align-middle">{{ events.categories }}</td>
                                                       ...
                                                       <td class="text-nowrap align-middle"><span>{{ events.jour }} - {{ events.mois }}</span>
                                                       </td>
