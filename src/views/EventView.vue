                ...
                <div class="col-lg-7 col-sm-12">
                    <div class="padding-60px-lr md-padding-50px-lr sm-padding-30px-all xs-padding-25px-all">
                        <h5
                            ...
                            <a :href="`/all`" class="text-theme-color">Business Conference</a></h5>
                        ...
                        <p>Duis autem vel eum iriure dolor in hendrerit in vulputate velit esse molestie consequat, vel
                            illum dolore</p>
                        <a class="butn small margin-10px-top md-no-margin-top" :href="`/details`">Read Mors <i
            ...
            <div class="row align-items-center event-block no-gutters margin-40px-bottom">
                <div class="col-lg-7 order-2 order-lg-1">
                    <div class="padding-60px-lr md-padding-50px-lr sm-padding-30px-all xs-padding-25px-all">
                        <h5
                            class="margin-15px-bottom md-margin-10px-bottom font-size22 md-font-size20 xs-font-size18 font-weight-500">
                            <a :href="`/all`" class="text-theme-color">Craft Workshops</a></h5>
                        <ul class="event-time margin-10px-bottom md-margin-5px-bottom">
            ...
            <div class="row align-items-center event-block no-gutters margin-40px-bottom">
                ...
                <div class="col-lg-7 col-sm-12">
                    <div class="padding-60px-lr md-padding-50px-lr sm-padding-30px-all xs-padding-25px-all">
                        <h5
                            class="margin-15px-bottom md-margin-10px-bottom font-size22 md-font-size20 xs-font-size18 font-weight-500">
                            <a :href="`/all`" class="text-theme-color">Mentorship Program</a></h5>
                        <ul class="event-time margin-10px-bottom md-margin-5px-bottom">
            ...
            <div class="row align-items-center event-block no-gutters margin-40px-bottom">
                <div class="col-lg-7 order-2 order-lg-1">
                    <div class="padding-60px-lr md-padding-50px-lr sm-padding-30px-all xs-padding-25px-all">
                        <h5
                            class="margin-15px-bottom md-margin-10px-bottom font-size22 md-font-size20 xs-font-size18 font-weight-500">
                            <a :href="`/all`" class="text-theme-color">Technical Events</a></h5>
                        <ul class="event-time margin-10px-bottom md-margin-5px-bottom">
            ...
            <div class="row align-items-center event-block no-gutters">
                ...
                <div class="col-lg-7 col-sm-12">
                    <div class="padding-60px-lr md-padding-50px-lr sm-padding-30px-all xs-padding-25px-all">
                        <h5
                            class="margin-15px-bottom md-margin-10px-bottom font-size22 md-font-size20 xs-font-size18 font-weight-500">
                            <a :href="`/all`" class="text-theme-color">Startup Events</a></h5>
                        <ul class="event-time margin-10px-bottom md-margin-5px-bottom">
